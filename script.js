...
const footprintPlaces = [
  ...
  },
  {
    ...
    placeZh: "欧洲大陆",
    noteEn: "Travel footprints across France, the Netherlands, Switzerland and Spain-linked islands.",
    noteZh: "法国、荷兰、瑞士及西班牙相关岛屿等欧洲旅行足迹。",
    typeEn: "Travel",
    typeZh: "旅行",
    spreadX: 5,
    spreadY: 3.8,
    cities: ["芒什省", "奥恩省", "巴黎省", "塞纳-马恩省", "北荷兰省", "卢塞恩市", "拉斯帕尔马斯"]
  },
  {
    x: 72,
    y: 46.5,
    ...
    spreadX: 8.5,
    spreadY: 7.4,
    cities: ["北京", "天津", "石家庄市", "唐山市", "承德市", "廊坊市", "秦皇岛市", "衡水市", "太原市", "晋中市", "忻州市", "通辽市", "哈尔滨市", "吉林市", "长春市", "延边朝鲜族自治州", "沈阳市", "大连市", "盘锦市", "营口市", "锦州市", "葫芦岛市", "鞍山市", "辽阳市", "本溪市", "朝阳市", "铁岭市"]
  },
  {
    x: 73.8,
    y: 52,
    ...
    spreadX: 9,
    spreadY: 8,
    cities: ["济南市", "青岛市", "烟台市", "淄博市", "德州市", "滨州市", "临沂市", "泰安市", "枣庄市", "镇江市", "苏州市", "徐州市", "宿州市", "杭州市", "上海市", "南昌市", "九江市", "武汉市", "长沙市", "郑州市", "深圳市", "东莞市", "佛山市", "广州市", "南充市", "成都市", "乐山市", "绵阳市"]
  },
  {
    x: 69,
    y: 54.8,
    ...
    spreadX: 8,
    spreadY: 8,
    cities: ["重庆市", "榆林市", "商洛市", "拉萨市", "那曲市", "林芝市", "山南市", "玉树藏族自治州", "海西蒙古族藏族自治州", "西宁市", "海南藏族自治州", "海北藏族自治州", "海东市", "兰州市", "定西市", "天水市", "宝鸡市", "西安市", "咸阳市"]
  },
  {
    x: 78.2,
    y: 49.6,
  ...
  },
  {
    x: 62,
    y: 57.5,
    countryEn: "Middle East & North America",
    countryZh: "中东与北美",
    placeEn: "Abu Dhabi and North America",
    placeZh: "阿布扎比与北美",
    noteEn: "Long-distance footprints represented in the badge map, including Abu Dhabi and North American counties.",
    noteZh: "徽章地图中的远距离足迹，包括阿布扎比及北美地区。",
    typeEn: "Travel",
    typeZh: "旅行",
    spreadX: 5.5,
    spreadY: 4,
    cities: ["阿布扎比", "圣塔克鲁兹县", "奥兰治县"]
  }
];
...
const cityCoordinates = {
  ...
  "芒什省": [49.05, -1.25], "奥恩省": [48.57, 0.08], "巴黎省": [48.86, 2.35], "塞纳-马恩省": [48.84, 2.65], "北荷兰省": [52.52, 4.95], "卢塞恩市": [47.05, 8.31], "拉斯帕尔马斯": [28.12, -15.43],
